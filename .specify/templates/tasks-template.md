...
**Tests**: Automated tests are REQUIRED for behavior changes. Include the lowest
useful test layer plus integration, contract, regression, or UI tests when the
plan identifies an affected boundary or user journey. If automation is not
practical, include an explicit verification task with the rationale from plan.md.
...
- [ ] T004 [P] Configure automated test command and fixtures
...
### Tests for User Story 1 (required before implementation) ⚠️
...
- [ ] T013 [P] [US1] Regression/unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T019 [US1] Add loading, empty, error, and success UX states where applicable
- [ ] T020 [US1] Add logging for user story 1 operations
- [ ] T021 [US1] Validate performance budget for [affected path]
...
### Tests for User Story 2 (required before implementation) ⚠️
...
- [ ] T024 [P] [US2] Regression/unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T028 [US2] Add required UX states and accessibility behavior where applicable
- [ ] T029 [US2] Integrate with User Story 1 components (if needed)
- [ ] T030 [US2] Validate performance budget for [affected path]
...
- [ ] T033 [P] [US3] Regression/unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T037 [US3] Add required UX states and accessibility behavior where applicable
- [ ] T038 [US3] Validate performance budget for [affected path]
...
- [ ] TXXX Run full automated test suite and record results
...
- Tests MUST be written and FAIL before implementation for automated coverage tasks
