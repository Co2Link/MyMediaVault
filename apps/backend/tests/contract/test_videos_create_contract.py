...
def test_post_videos_accepts_valid_hash(client: TestClient, act_as, standard_user) -> None:
...
def test_post_videos_conflicts_for_duplicate_personal_entry(client: TestClient, act_as, standard_user) -> None:
    act_as(standard_user)
